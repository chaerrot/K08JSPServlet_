...
public class ListController extends  HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
		...
		//파라미터 및 View로 전달한 데이터 저장용 Map컬렉션 생성
		...
		/*** 페이지 처리 start ***/
		//web.xml에 접근하기 위해 서블릿에서 applicaion 내장 객체를 얻어옴.
		...
		/*
			목록에 첫 진입 시에는 무조건 1페이지로 가정한 후 게시물을 얻어옴.
		...
		*/
		...
		map.put("pageSize", pageSize); //한 페이지에 출력한 게시물의 개수
