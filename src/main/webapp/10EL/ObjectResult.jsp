...
<body>
	...
	<h2>JSP내장 객체를 통해 영역의 값 읽어오기</h2>
	<%
		//영역에 모든 객체를 저장할 수 있는 공간이므로 Object형으로 저장된다.
		Object object = request.getAttribute("personObj");
		//따라서 영역에서 객체를 꺼내서 사용할 때는 원래 형으로 형변환해야 한다.
	...
	<ul>
		<!-- EL에서는 산술 연산이 가능하므로 아래에서는 30이 출력된다.
			또한 파라미터로 전달된 문자열을 숫자로 자동변환해준다. -->
