...
<body>
	<h2>1. 로그인 폼</h2>
	<%
	//get방식으로 전달된 loginErr 파라미터가 있는 경우에는 "로그인실패"를 출력한다.
	String loginErr = request.getParameter("loginErr");
	//첫 실행시에는 아무것도 출력되지 않는다.
	if (loginErr != null) out.print("로그인 실패");
	%>
	<!-- 로그인을 위해 post 방식으로 폼값을 전송한다. get방식으로 전송하면
		로그인 정보가 쿼리스트링 형태로 주소줄에 남기 때문에 개인정보유출의
	 	위험이 있다. 따라서 로그인 정보와 같은 경우 post방식을 주로 사용한다. -->
