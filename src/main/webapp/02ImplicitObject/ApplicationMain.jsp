...
<body>
	...
	<!-- 
		...
		따라서 아래의 물리적 경로는 metadata하위의 경로가 출력되게 된다.
	 -->
	...
	<%!
		/*
			선언부에서는 내장 객체를 바로 사용하는 건 불가능하다.
			내장 객체는 _jspService()메서드 내에서 생성된 지역변수이므로 더 넓은 지역이
			선언부에서 사용하려면 매개변수로 전달 받아야 한다.
		*/
		...
		public String useImplicitObject(ServletContext app) {
			/*
				방법2: 스트립트릿에서 메서드 호출 시 application 내장 객체를
					매개변수로 전달해서 사용한다.
			*/
