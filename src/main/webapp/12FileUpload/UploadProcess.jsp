...
<%
	...
	//업로드할 파일의 최대 용량 설정 (만약 2개라면 둘을 합친 용량으로 설정)
	...
	try {
		/*
			...
			객체가 생성됨과 동시에 첨부한 파일은 서버에 업로드된다.
		...
		*/
		...
		//파일을 제외한 나머지 폼값을 받는다. 이 때 request 객체를 통해 받는 것이
		//아니므로 주의해야 한다.
		String name = mr.getParameter("name");
		String title = mr.getParameter("title");
		//checkbox의 경우 여러 개의 값이 전송되므로 문자열을 연결해준다.
